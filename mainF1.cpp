...
int main() {
    ...
    if (choice == 5) {
        ...
        cout << "[ + ] Фигура: \"Четверть квадрата\"" << endl << endl;
        ...
        int startRow = size - quarterSize;
        int startCol = size - quarterSize;
            ...
            for (int j = 0; j < size; j++) {
                if (i >= startRow && j >= startCol) {
                    if (type == 1) {
                        ...
                        if (i == startRow, j == startCol, i == size - 1 || j == size - 1) {
                            cout << texture;
                        }
                        else {
                            cout << ".";
